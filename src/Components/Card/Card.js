  ...
  return (
    <div className='card-container-div border overflow-hidden rounded-xl'>
        ...
        <div className='flex flex-col'>
          ...
          <button className='text-white py-1 text-base font-semibold flex items-center justify-center' style={{backgroundColor: '#35353C'}}>Add To Cart <BsCart3 className='text-lg ml-1' style={{color: '#F3A847'}}/></button>
        </div>
